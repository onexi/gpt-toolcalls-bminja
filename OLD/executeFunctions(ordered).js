...
const execute = async (functionCalls) => {
    ...
    // Sort functionCalls by the order property
    functionCalls.sort((a, b) => (a.order || 0) - (b.order || 0));
...
const details = {
                ...
                functionCalls: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            order: {
                                type: 'number',
                                description: 'The order in which to execute the function. Lower numbers are executed first.'
                            }
                        },
    ...
    description: 'This function executes multiple functions based on the provided functionCalls array.'
};
